                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-simple text-center card-box">
                            <h3 class=" text-pink counter font-bold mt-0" id="pQuantity"></h3>
                            <p class="text-muted mb-0">押犯总数</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-simple text-center card-box">
                            <h3 class="text-primary counter font-bold mt-0" id="policeQuantity"></h3>
                            <p class="text-muted mb-0">干警总数</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-simple text-center card-box">
                            <h3 class="text-success font-bold mt-0"><span class="counter" id="pRealQuantity"></span></h3>
                            <p class="text-muted mb-0">实押人数</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-simple text-center card-box">
                            <h3 class="text-warning counter font-bold mt-0" id="policeOnDutyQuantity"></h3>
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <table class="table  table-bordered table-striped tablesaw">
                                ...
                                <tr>
                                    <td>值&nbsp;&nbsp;班&nbsp;&nbsp;员：</td>
                                    <td><span class="zhiban-name" id="pOnDuty"></span></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>检&nbsp;&nbsp;查&nbsp;&nbsp;站：</td>
                                    <td><span class="zhiban-name" id="pInStation"></span></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>指挥中心：</td>
                                    <td><span class="zhiban-name" id="pInCommandCenter"></span></td>
                                    <td></td>
                                </tr>
                                </tbody>
                            </table>
