        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="message-box">
                    <h1 class="m-b-0"><%=null==errorCode?"500":errorCode%></h1>
                    <p><%=null==eMsg?"内部错误，请联系管理员":eMsg%></p>
                    <div class="buttons-con">
                        <div class="action-link-wrap">
                            <a onclick="history.back(-1)" href="" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">后退</a>
