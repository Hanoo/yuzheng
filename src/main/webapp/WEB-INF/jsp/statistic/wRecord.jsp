...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/js/easyui/themes/black/easyui.css"/>
    <link rel="stylesheet" type="text/css" href="style/js/easyui/themes/icon.css"/>
    <link rel="stylesheet" type="text/css" href="style/css/customdatagrid.css"/>

    <script type="text/javascript" src="style/js/echart3/jquery-2.0.3.min.js"></script>
